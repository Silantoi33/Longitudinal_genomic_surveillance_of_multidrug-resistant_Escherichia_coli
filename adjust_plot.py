...
# Print the contents of ref_starts to check if it contains any data
print("ref_starts:", ref_starts)

# Plot the alignment if there is data
if ref_starts:
    ...
    # Adjust plot limits
    plt.xlim(min(ref_starts), max(ref_starts))
    plt.ylim(min(query_starts), max(query_starts))
